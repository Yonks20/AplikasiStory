package com.project.submissioninter.customview
...
class CustomPasswordEditText: AppCompatEditText {
    ...
    private fun init(){
        iconPasswordDrawable = ContextCompat.getDrawable(context, R.drawable.icon_password) as Drawable
        ...
        addTextChangedListener(object : TextWatcher {
            ...
            override fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {
                if (!p0.isNullOrEmpty() && p0.length < 8 ){
                    error = context.getString(R.string.fld_pass_error)
                }
            }
